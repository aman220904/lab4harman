...
import com.example.lab4harman.R;

import java.util.ArrayList;

public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MyRowHolder> {
    ...
    public MyRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) {  // Sent message
            ...
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rec_message, parent, false);
        }
